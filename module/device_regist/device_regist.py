...
from module.device_regist.flurl.request_params import generate_url_params, generate_url_common_params
from module.device_regist.flurl.utils  import UUID, md5, generate_android_id,generate_random_mac,gzip_compress, printf, cookie_string, cookie_json, get_trace_id
from module.device_regist.flurl.ttEncryptorUtil  import ttEncrypt
import requests
from module.device_regist.flurl.core import core_sixgod
    ...
    def _init_device_info(self):
        ...
        return {
            'device':{
                ...
                'openudid': openudid,
                # 'resolution': f'1440*23{random.randint(80, 99)}',
                'resolution': f'1440*2392',
                'dpi': '560',
                'cdid': cdid,
                'uuid': uuid,
