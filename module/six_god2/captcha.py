...
class ByteDanceCaptchaAndroid(object):
    headers = {
    ...
    def download_img(self, img_url):
        __res = self.session.get(img_url, headers=self.headers, timeout=30, verify=False)
    ...
    def verify_slide(self):
        ...
        logger.info(f"滑动的距离为: {dis}, 高度为: {dis_x}")
        track_data = {
...
#print(ByteDanceCaptchaAndroid(did='3308889424278729',iid='3308889423512793',detail='5wwxgFOBfz0gYqxXaOvJ*HACqzQuTkLDOixACovSn8WfvMGGEY8*Hk1y47ZDdnr*EAV3sfaxPdlIaylcI0rTompQJok4hH0Q85GQCp4IxqiRK0CGxrXqxS4joyVmaytYxPG-LST9T-9Oy9reoZVy0mw9dzjEAJ1AGk5ZvTwbuSXbwJNPls*DTAjF4ynpTjliyFubIQ4Dliuw9IwRLHZYpuG3xkwariGQ2l6XvNPGslzbQIPu7YklZBkimDC053-hAHU2daCDJ28GTAQ3mOUVt9WmY0HTtMbn096ls1aRRgxG3Nzh*S3bI2ezevuIKCqlgSF6wPgou-qGb4eCcQp6ITdqX8aibrdCWpTokQ-c8mEVDqor4uVzwXxg*-D46y6vnV4vwu9njBdkOeyoXkeH-QCbD2v9vn*TACfg0CvMhwqau7vAwU3tdvhGLAjBxcoVXyz1637jwr4iF0D*TqHqop5XYwHt6EujdMGeIlpthk6STR1AjhuH5UNR').verify_track())