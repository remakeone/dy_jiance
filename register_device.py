...
def device_register(daili = None):
    proxy = {'http': daili, 'https': daili} if daili else {}
    cdid = str(uuid.uuid4())
    ...
    params = {
        ...
        'manifest_version_code': '360201',
        'resolution': '1440*3007',
        'dpi': '560',
        'update_version_code': '36209900',
    ...
    try:
        ...
        resp = requests.post(url, data=register_body, headers=headers, proxies=proxy)
        resp_json = resp.json()
